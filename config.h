...
static Key keys[] = {
	...
	{ShiftMask, XF86XK_MonBrightnessUp, spawn, {.v = brightness_up_slight}},
	{ShiftMask, XF86XK_MonBrightnessDown, spawn, {.v = brightness_down_slight}},
